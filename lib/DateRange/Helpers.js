  ...
  humanizeDateRange: function humanizeDateRange(value, tzName, dateFormat) {
    ...
    switch (value.rangeType) {
      case 'custom':
        ...
        return (0, _Helpers.t)('common:::dateRange::Custom');
      case 'today':
        start_at = _momentTimezone2.default.tz(tzName).format(dateFormat);
        return (0, _Helpers.t)('common:::dateRange::Today') + ' : ' + start_at;
      case 'yesterday':
        start_at = _momentTimezone2.default.tz(tzName).subtract(1, 'days').format(dateFormat);
        return (0, _Helpers.t)('common:::dateRange::Yesterday') + ' : ' + start_at;
      case 'this_week':
        return (0, _Helpers.t)('common:::dateRange::This Week (Sun - Today)');
      case 'last_week':
        return (0, _Helpers.t)('common:::dateRange::Last Week (Sun - Sat)');
      case 'last7':
        return (0, _Helpers.t)('common:::dateRange::Last 7 Days');
      case 'last14':
        return (0, _Helpers.t)('common:::dateRange::Last 14 Days');
      case 'this_month':
        return (0, _Helpers.t)('common:::dateRange::This Month');
      case 'last_month':
        return (0, _Helpers.t)('common:::dateRange::Last Month');
      case 'all_time':
        return (0, _Helpers.t)('common:::dateRange::All Time');
      default:
    }
  }
};
