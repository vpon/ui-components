...
var DataTable = function (_Component) {
  ...
  function DataTable(props) {
    ...
    _this.getColumns = function () {
      ...
      var isCheckedAll = _this.props.dataSource.length !== 0 && _this.props.selectedIds && _this.props.selectedIds.length === _this.props.dataSource.length;
      var selectorColumn = {
        name: 'index',
        width: 35,
        title: _react2.default.createElement('input', { type: 'checkbox', id: 'select_all', onChange: _this.handleCheckAll, checked: isCheckedAll }),
        sortable: false,
      ...
      _this.columns = _this.props.selectable ? [selectorColumn].concat(_this.props.columns) : _this.props.columns;
