...
var DataTable = function (_Component) {
  ...
  function DataTable(props) {
    ...
    var selectorColumn = {
      name: 'index',
      width: 35,
      title: _react2.default.createElement('input', { type: 'checkbox', id: 'select_all', onChange: _this.handleCheckAll, checked: props.dataSource.length !== 0 && props.selectedIds && props.selectedIds.length === props.dataSource.length }),
      sortable: false,
      style: { textAlign: 'center' },
      render: function render(value, data) {
        return _react2.default.createElement('input', { 'data-record-id': data[props.idProperty], type: 'checkbox', checked: props.selectedIds.indexOf(data[props.idProperty]) !== -1, onChange: _this.handleCheck.bind(_this, data[props.idProperty]) });
      }
    };

    _this.columns = props.selectable ? [selectorColumn].concat(props.columns) : props.columns;

    _this.resetColumns = function (newProps) {
      _this.columns = newProps.selectable ? [selectorColumn].concat(newProps.columns) : newProps.columns;
    };
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var components = [_react2.default.createElement(_reactDatagrid2.default, {
