...
var DataTable = function (_Component) {
  ...
  _createClass(DataTable, [{
    ...
    value: function componentDidUpdate() {
      ...
      var $vScrollbar = $scope.find('.z-vertical-scrollbar');
      var $vScroller = $scope.find('.z-vertical-scroller');
      ...
      if ($vScrollbar.outerHeight(true) >= $vScroller.outerHeight(true)) {
        var $contentWrapper = $scope.find('.z-content-wrapper-fix');
        var $lastCell = $contentWrapper.find('.z-last');
