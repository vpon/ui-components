...
var CustomDialog = function (_Component) {
  ...
  function CustomDialog(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CustomDialog).call(this, props));
    ...
    _this.state = {
      ...
      defaultDate: _momentTimezone2.default.tz(props.start_at, props.tzName).format(props.dateFormat)
    };
    ...
    _this.handleInputChange = function (e) {
      ...
      if ((0, _momentTimezone2.default)(input.value, _this.props.dateFormat, true).isValid()) {
    ...
    _this.handleInputBlur = function (e) {
      ...
      if (isValid) {
        ...
        _this.setState(newState);
        (0, _jquery2.default)((0, _reactDom.findDOMNode)(_this)).find('#date_range_datepicker').datepicker('setDate', null);
      }
    };
    ...
    _this.setupDatepicker = function () {
      var self = _this;
      var $dialog = (0, _jquery2.default)('#date_range_custom_dialog');
      ...
      $datepicker.datepicker({
        ...
        beforeShowDay: function beforeShowDay(date) {
          var cssClasses = [];
          var selectedDate = _jquery2.default.datepicker.formatDate('yy/mm/dd', date);
  ...
  _createClass(CustomDialog, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery2.default)('#date_range_custom_dialog').on('change', 'input', function (e) {
    ...
    value: function componentWillUnmount() {
      (0, _jquery2.default)((0, _reactDom.findDOMNode)(this)).find('#date_range_datepicker').datepicker('destroy');
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            _i18next2.default.t('common:::dateRange::Custom Date Range')
          )
        ),
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _i18next2.default.t('common:::Apply')
          )
        )
      );
    }
