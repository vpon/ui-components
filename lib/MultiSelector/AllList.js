...
var AllList = function (_Component) {
  ...
  _createClass(AllList, [{
    ...
    value: function renderBreadcrumb() {
      ...
      var parentName = (0, _get2.default)((0, _find2.default)(this.props.allItem, function (i) {
    ...
    value: function render() {
      ...
      var allColumns = this.props.dataTableProps.parent_id ? columns : [this.selectorColumn].concat(columns);
...
AllList.propTypes = {
  ...
  inheritedItems: _react.PropTypes.array.isRequired,
